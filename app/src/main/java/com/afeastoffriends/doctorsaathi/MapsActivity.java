...
import static com.afeastoffriends.doctorsaathi.AppConfig.PLACE_ID;
...
import static com.afeastoffriends.doctorsaathi.AppConfig.SUPERMARKET_ID;
...
//YOU Can change this type at your own will, e.g hospital, cafe, restaurant.... and see how it all works
        ...
        JsonObjectRequest request = new JsonObjectRequest(googlePlacesUrl.toString(),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject result) {
                        ...
                        Log.i("6","chai Latitudeyyman laatitudey");
    ...
    private void parseLocationResult(JSONObject result) {
        String id, place_id, placeName = null, reference, icon, vicinity = null, rating=null;
